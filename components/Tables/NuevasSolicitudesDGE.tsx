...
import LoadSolicitudesCobranza from "../../hooks/useLoadSolicitudesCobranza";
import LoadSolicitudesDGE from "../../hooks/useLoadSolicitudesDGE";

const NuevasSolicitudesDGE = () => {
  ...
  useEffect(() => {
    ...
    async function llenarTabla() {
      const peticion = await LoadSolicitudesDGE(activePage);
            ...
            data.length === 0 ? (
              ...
              <tbody>
                {data.map((user: any, i: number) => (
                  <>
                    {user.solicitudes_pendientes_d_g_e.length !== 0 ? (
                      <>
                        <tr
                          key={i}
                        ...
                        >
                          <th>{user.rut}</th>
                          <th>{user.name}</th>
                          <th>{user.solicitudes_pendientes_d_g_e.length}</th>
                          <th>
                            <Whisper
                              placement="top"
                              trigger="hover"
                          ...
                          <td colSpan={4}>
                            ...
                            >
                              <table className="table table-striped table-bordered">
                                ...
                                <tbody>
                                  {user.solicitudes_pendientes_d_g_e.map(
                                    (solicitud: any, z: any) => (
                                      <tr key={z}>
                                        <td>{solicitud.id}</td>
...
export default NuevasSolicitudesDGE;
